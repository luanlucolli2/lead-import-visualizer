...
export const Header = ({
  ...
  return (
    <div className="sticky top-0 z-10 bg-white border-b border-gray-200 w-full">
      <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 w-full max-w-full">
        <div className="space-y-3 sm:space-y-4 w-full">
          ...
          <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between w-full min-w-0">
            {/* Search Field */}
            <div className="relative w-full sm:max-w-xs md:max-w-sm lg:max-w-md min-w-0 flex-shrink">
            ...
            {/* Action Buttons */}
            <div className="flex items-center space-x-2 w-full sm:w-auto sm:flex-shrink-0 min-w-0">
              <Button 
                onClick={() => setIsFiltersModalOpen(true)} 
                variant="outline" 
                size="sm"
                className={cn(
                  "flex-1 sm:flex-none border-gray-300 hover:bg-gray-50 relative text-xs sm:text-sm px-2 sm:px-3 min-w-0",
                  hasActiveFilters && "border-blue-500 bg-blue-50 text-blue-700"
                )}
              >
                <Filter className="w-3 h-3 sm:w-4 sm:h-4 sm:mr-2 flex-shrink-0" />
              ...
              <Button 
                ...
                variant="outline" 
                size="sm"
                className="flex-1 sm:flex-none border-gray-300 hover:bg-gray-50 text-xs sm:text-sm px-2 sm:px-3 min-w-0"
              >
              ...
              <Button 
                ...
                size="sm"
                className="flex-1 sm:flex-none bg-blue-600 hover:bg-blue-700 text-xs sm:text-sm px-2 sm:px-3 min-w-0"
              >
                <Upload className="w-3 h-3 sm:w-4 sm:h-4 sm:mr-2 flex-shrink-0" />
