              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {leads.map((lead) => (
                  <tr key={lead.id} className="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td className="px-4 py-4 text-sm text-gray-900 font-medium max-w-[200px]">
                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      <div className="flex flex-col space-y-1">
                        ...
                        <span className="text-xs text-gray-500 truncate max-w-[120px]" title={lead.motivo}>
                          {lead.motivo}
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                      <span className="inline-flex px-2 py-1 text-xs font-medium bg-purple-100 text-purple-800 rounded-full max-w-[100px] truncate" title={lead.origem}>
                        {lead.origem}
                      </span>
                    </td>
                    <td className="px-4 py-4 whitespace-nowrap">
            ...
            <div key={lead.id} className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2 min-w-0 flex-1">
                  ...
                  <span className="inline-flex px-2 py-1 text-xs font-medium bg-purple-100 text-purple-800 rounded-full truncate max-w-[80px]" title={lead.origem}>
                    {lead.origem}
                  </span>
                </div>
              ...
              <div className="flex justify-between items-center text-xs text-gray-500 pt-2 border-t">
                ...
                <span className="truncate max-w-[120px]" title={lead.motivo}>{lead.motivo}</span>
              </div>
            </div>
          ))}
        </div>
